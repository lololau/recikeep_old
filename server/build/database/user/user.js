...
var getUserByFirebaseID = function (fbid) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                db = _a.sent();
                return [4 /*yield*/, db.get.apply(db, unamed("SELECT * FROM User WHERE firebase_id = :firebaseId", {
                        firebaseId: fbid,
                    }))];
            case 2:
                ret = _a.sent();
...
var createUser = function (fbid, fullN) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                db = _a.sent();
                return [4 /*yield*/, db.run.apply(db, unamed("INSERT INTO User (firebase_id, full_name) VALUES (:firebaseId, :fullName)", {
                        firebaseId: fbid,
                        fullName: fullN,
                    }))];
            case 2:
...
var getUserIdByFirebaseID = function (fbid) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                db = _a.sent();
                return [4 /*yield*/, db.get.apply(db, unamed("SELECT id FROM User WHERE firebase_id = :firebaseId", {
                        firebaseId: fbid,
                    }))];
            case 2:
                ret = _a.sent();
...
var updateUser = function (fbid, fullN) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                user_id = _a.sent();
                return [4 /*yield*/, db.run.apply(db, unamed("UPDATE User SET full_name=:fullName WHERE id = :userId", {
                        fullName: fullN,
                        userId: user_id,
                    }))];
            case 3:
