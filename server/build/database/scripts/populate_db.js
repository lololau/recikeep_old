        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                users.forEach(function (user) {
                    db.run("INSERT INTO User (id, username, date_creation, date_update) VALUES ($id, $username, $date_creation, $date_update)", {
                        $id: user.id,
                ...
                ingredients.forEach(function (ingredient) {
                    db.run("INSERT INTO Ingredient (id, name, date_creation, date_update) VALUES ($id, $name, $date_creation, $date_update)", {
                        $id: ingredient.id,
                ...
                recipes.forEach(function (recipe) {
                    db.run("INSERT INTO Recipe (id, name, number_parts, date_creation, date_update, user_id) \n            VALUES ($id, $name, $number_parts, $date_creation, $date_update, $user_id)", {
                        $id: recipe.id,
                        $name: recipe.name,
                ...
                recipes_ingredients.forEach(function (recipe_ingredients) {
                    db.run("INSERT INTO Recipe_ingredient (recipe_id, ingredient_id, quantity, unity) VALUES ($recipe_id, $ingredient_id, $quantity, $unity)", {
